...
Use the example.html as a reference while creating new html or add to existing ones
do not put style in html
use the same style in all html file
answer this question using the note of the subject which being be in the same folder as the html file
answer in a way that I will get full marks in exam
